    ...
    <div className="max-w-2xl mx-auto py-12">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8 space-y-4">
        ...
        <ul className="text-gray-300 text-sm space-y-2 leading-relaxed">
          <li className="flex gap-2"><span className="text-accent">⚽</span> Spot kicks are currently planned for this category.</li>
          <li className="flex gap-2"><span className="text-accent">🏟</span> Depending on the interest shown by participants, we may also arrange a full match with <strong className="text-white">5-minute halves</strong>.</li>
        </ul>
