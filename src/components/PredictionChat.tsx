    ...
    <div className="fixed bottom-4 right-4 z-[80] sm:bottom-6 sm:right-6">
      {open && (
        <section
          ...
          className="mb-3 flex h-[min(72vh,590px)] w-[calc(100vw-2rem)] max-w-[390px] flex-col overflow-hidden rounded-3xl border border-white/15 bg-slate-950/90 shadow-2xl shadow-black/50 backdrop-blur-2xl"
        >
