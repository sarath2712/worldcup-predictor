...
def generate():
    ...
    portrait = cover_image(ROOT / "public/winners/pavan-itagi.webp", 185, 305, 0.4)
    artwork = cover_image(
        ROOT / "public/winners/trupti-itagi-caricature.webp",
        275,
        185,
        0.5,
    )
    ...
    pdf.drawImage(portrait, 56, 385, 185, 305, mask="auto")
    pdf.setFillColor(white)
    pdf.roundRect(260, 505, 293, 195, 8, fill=1, stroke=0)
    pdf.drawImage(artwork, 269, 510, 275, 185, mask="auto")
    ...
    pdf.setFillColor(MUTED)
    pdf.setFont("Helvetica-Bold", 11)
    pdf.drawString(270, 420, "Champion | Flat 8043 | 9 votes")
    pdf.setFont("Helvetica", 9.5)
    text = pdf.beginText(270, 390)
    text.setLeading(16)
